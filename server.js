...
app.post('/onboarding', (req, res) => {
  const {
      ...
      else if(goal === "Potentially increase my portfolio’s value at a moderate pace while accepting moderate to high levels of risk or loss of principal") willingness_points += 1;
